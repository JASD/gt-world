...
@NamedQueries({
    ...
    @NamedQuery(name = "Red.findByUser", query = "SELECT r FROM Red r WHERE r.idRed IN (SELECT m.miembroPK.idRed FROM Miembro m WHERE m.miembroPK.idUsuario = :idUsuario)")})
