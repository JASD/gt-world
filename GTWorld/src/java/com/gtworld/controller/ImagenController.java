...
public class ImagenController implements Serializable {
    ...
    @EJB
    private com.gtworld.facade.ImagenFacade ejbFacade;
    ...
    public static class ImagenControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Imagen) {
                ...
                return getStringKey(o.getCorrelativoImagen());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ImagenController.class.getName());
            }
        }
    }
}
