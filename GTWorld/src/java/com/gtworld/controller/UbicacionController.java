...
public class UbicacionController implements Serializable {
    ...
    @EJB
    private com.gtworld.facade.UbicacionFacade ejbFacade;
    ...
    public static class UbicacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Ubicacion) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + UbicacionController.class.getName());
            }
        }
    }
}
